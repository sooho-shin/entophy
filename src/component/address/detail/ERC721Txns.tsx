  ...
  return (
    <>
      <InfoRow>
        ...
        {detailData ? (
          <Link to={`/tokens/transfers721?address=${param}`}>View all</Link>
        ) : (
      ...
      <WhiteBox>
        {detailData ? (
          ...
          >
            {detailData && !detailData.ERC721_token_transaction_list.length && (
              <NoDataTr colspan={6} text="nodata" />
            )}
            {detailData &&
              detailData.ERC721_token_transaction_list.length > 0 &&
              detailData.ERC721_token_transaction_list.map(
                (c: ERC721TokenTransactionListType, i: number) => {
                  return (
                    <tr key={i}>
                      <td>
                        <p>
                      ...
                      <AgeTd
                        date={c.create_date}
                        last={detailData.ERC721_token_transaction_list.length - 1 === i}
                      />
                      <td>
                        <p>
                          <Link
