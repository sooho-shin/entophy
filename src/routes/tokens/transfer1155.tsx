...
import Transfer1155Table from '../../component/tokens/Transfer1155Table';
import bignumberUtil from '@/utils/bignumber';
import { usePaginationStore } from '@/store/pagination';
import Wrapper from '@/component/common/Wrapper';

const Transfer1155: FC = () => {
  ...
  useEffect(() => {
    resetAllData();
    if (searchParams) {
      fetchTransferData({ type: 'erc1155', ...currentParams });
    }
  }, [searchParams]);
  return (
    <Wrapper>
      <div className="top-row">
        <TitleRow>
          <>
            <h1>ERC-1155 Token Transfers</h1>
