...
import Rank1155Table from '@/component/tokens/Rank1155Table';
...
const Rank1155: FC = () => {
  ...
  useEffect(() => {
    resetAllData();
    if (searchParams) {
      fetchTokenData({ type: 'erc1155', ...currentParams });
    }
  }, [searchParams]);
  return (
    <Wrapper>
      ...
      <div className="paging-row">
        <p>
          ...
          ERC-1155 Token Contracts found
        </p>
        <Pagination />
      </div>
      <WhiteBox>
